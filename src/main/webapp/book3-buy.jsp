...
<div class="wrapper">
    ...
    <section class="container">
        <div class="order-container">
            <div class="order">
                ...
                <div class="order__control">
                    ...
                    <a href="book-final.jsp" class="order__control-btn">预订</a>
                </div>
            </div>
        </div>
        <div class="order-step-area">
            <div class="order-step first--step order-step--disable ">1.选择电影与日期</div>
            <div class="order-step second--step order-step--disable">2. 选座</div>
        ...
        <div class="col-sm-12">
            ...
            <div class="order">
                <a href="book-final.jsp" class="btn btn-md btn--warning btn--wide">购买</a>
            </div>
    ...
    <div class="booking-pagination">
        <a href="book2.jsp" class="booking-pagination__prev">
            ...
            <span class="arrow__info">选座</span>
        </a>
...
<script  id="demo1" type="text/template">
    <li class="book-result__item">总价： <span class="book-result__count booking-cost">￥{{:cost}}</span></li>
    </script>
