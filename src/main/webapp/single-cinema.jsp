...
<div class="wrapper">
    ...
    <!-- Main content -->
    <section class="cinema-container target">
...
<script  id="demo1" type="text/template">
    <div class="cinema cinema--full">
        <p class="cinema__title">{{:name}}</p>
        <div class="cinema__rating">{{:grade}}</div>
        ...
        <div class="cinema__info">
            <p class="cinema__info-item"><strong>地点:</strong> {{:address}}</p>
            <p class="cinema__info-item"><strong>电话:</strong>{{:tel}}</p>
            <p class="cinema__info-item"><strong>影院介绍:</strong> <a href="#">{{:text}}</a></p>
        </div>
    </div>
    </script>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $.ajax({
            type:"GET",
            url:"http://localhost:8080/myTest-1.0-SNAPSHOT/SelectCinemaByIdServlet",
            headers: {
